...
/// members is the only warning in the language; everything else is an error or is silent.
/// Further levels are deliberately absent until something needs one.</para>
/// </summary>
